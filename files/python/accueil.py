...
class Accueil(Frame):
    ...
    def __init__(self, main, jikan):
        ...
        self.main = main
        self.jikan = jikan
        self.lTitre = Label(self, bg="#9f9f9f", text = "Accueil", font="-size 25 -weight bold")
        self.lTitre.pack(pady = 15)
        
        self.lInfos = Label(self, bg="#9f9f9f", font = "-size 18", text = "Ce logiciel est un gestionnaire de manga / anime.\nMais il propose d'autres fonctionnalités :\n - Top d'anime/manga\n- Import de liste venant de MyAnimeList\n- Export de sa liste d'anime pour MyAnimeList\n\nIl a été créé par LavaPower\nVersion : 0.2.0 - Tops Update")
