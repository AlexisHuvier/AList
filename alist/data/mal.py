...
class MALProvider:
    ...
    def anime(self, id_=0, extension=None, page=None):
        try:
            return self.jikan.anime(id_, extension, page)
        except (exceptions.APIException, exceptions.JikanException, exceptions.DeprecatedEndpoint):
            return None

    def manga(self, id_=0, extension=None, page=None):
        try:
            return self.jikan.manga(id_, extension, page)
        except (exceptions.APIException, exceptions.JikanException, exceptions.DeprecatedEndpoint):
            return None
